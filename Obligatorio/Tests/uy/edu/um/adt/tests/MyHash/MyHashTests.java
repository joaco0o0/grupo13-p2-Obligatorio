...
public class MyHashTests {
    ...
    public void inserttest(){
        MyHashImpl<Integer,Integer> hash = new MyHashImpl<>();
        hash.put(1,2);
        hash.put(2,3);
        hash.put(3,4);
        hash.put(4,5);
    ...
    public void deletetest(){
        ...
        assertFalse(hash.contains(1) && hash.contains(4));
    ...
    public void containstest(){
        ...
        hash.put(3,4);
        hash.put(4,5);
        assertTrue(hash.contains(1) && hash.contains(2) && hash.contains(3) && hash.contains(4));
    }
